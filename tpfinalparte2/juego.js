class Juego {
  constructor() {
    ...
    this.tiempoAparicionTotal = 28000; // Los botones aparecen en los primeros 28 segundos
    ...
    this.puntos = new Puntos(this.totalBotones); // Sistema de puntos
  }
  ...
  verificarEstado() {
    ...
    if (this.tiempo.finalizado() && !this.puntos.completado()) {
